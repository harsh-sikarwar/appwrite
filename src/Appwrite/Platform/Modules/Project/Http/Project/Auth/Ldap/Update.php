...
class Update extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('provisionFilter', null, new Nullable(new Text(1024, 0)), 'Optional filter a user must also match to be allowed an account, typically a group membership. Evaluated on every sign-in, so removing someone from the group revokes their access.', optional: true)
